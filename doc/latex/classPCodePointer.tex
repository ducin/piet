...
\index{PCodePointer@{PCodePointer}!clear@{clear}}
\index{clear@{clear}!PCodePointer@{PCodePointer}}
...
\subsubsection[{getCoordinates}]{\setlength{\rightskip}{0pt plus 5cm}{\bf PPoint} PCodePointer::getCoordinates ()}}
...
\index{PCodePointer@{PCodePointer}!getPixel@{getPixel}}
\index{getPixel@{getPixel}!PCodePointer@{PCodePointer}}
...
Zwraca piksel o zadanych współrzędnych. \begin{Desc}
\item[Parametry:]
\begin{description}
...
\index{PCodePointer@{PCodePointer}!getPointedPixel@{getPointedPixel}}
\index{getPointedPixel@{getPointedPixel}!PCodePointer@{PCodePointer}}
